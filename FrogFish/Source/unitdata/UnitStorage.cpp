...
// TODO: BWAPI::Unit u need be const? Just copying a pointer.
// or is it because pointer to const? ...?
...
namespace {
    ...
    std::vector<BWAPI::Unit> self_units;
    std::vector<BWAPI::Unit> enemy_ID_2_eunit;
